  ...
  return (
    <div className='h-19 fixed bg-gradient-to-b from-white to-cyan-50 inset-0 flex justify-between items-center p-2 shadow-sm shadow-slate-200/50 opacity-100  '>
      ...
      <div className='flex flex-col justify-end place-items-end'>
        ...
        <span className='bg-blue-950 text-sm    py-1 px-3 rounded-lg  text-white font-semibold transition-all duration-900 ease-in-out animate-bounce mt-1 hover:animate-none hover:scale-105 hover:text-yellow-400'>+221 33 849 62 62</span>
      </div>
    </div>
  )
}
